...
while True:
    ...
    try:
        ...
        if count_defects == 0:
            ...
            p.press("p")
            cv2.putText(frame,"Previous video",(50,50), cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255), 2)
        elif count_defect ==4:
            p.press("m")
            cv2.putText(frame,"Mute",(50,50),cv2.Font_HERSHEY_SIMPLEX,2,(0,0,255),2)
        elif count_defect== 7:
            p.press("n")
            cv2.putText(frame, "Next video", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2)
        else:
            pass
